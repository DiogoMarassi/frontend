  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      ...
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-gray-500">Tente lembrar a tradução antes de virar o card. Depois, explique o significado das palavras em francês. Invente palavras, use a tradução rápida para ajudar... O importante é tentar explicar em voz alta.</p>
      </div>
      ...
      {cards.length === 0 ? (
        <div className="text-center py-20 text-gray-400">
          ...
          <p className="text-sm mt-1">
            Abra a{' '}
            <Link href={`/lesson/${id}`} className="text-blue-500 hover:underline">
              lição
            </Link>{' '}
            e clique em "Salvar" nas palavras destacadas.
          </p>
        </div>
      ) : (
